...
script_file=ChowMultiTool.pkgproj
...
npx notarize-cli --file $pkg_dir/ChowMultiTool-signed.pkg --bundle-id com.chowdsp.ChowMultiTool --asc-provider "$TEAM_ID" --username chowdsp@gmail.com --password "$INSTALLER_PASS"

echo "Building disk image..."
vol_name=Install_ChowMultiTool-$app_version
rm -f "$vol_name"
